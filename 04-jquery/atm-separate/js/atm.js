...
// It simply connects DOM elements to logical/business functions defined elsewhere (via event handlers).

// Our handy render() function updates every single part of the DOM with the
// latest values from our accounts object (defined elsewhere).
